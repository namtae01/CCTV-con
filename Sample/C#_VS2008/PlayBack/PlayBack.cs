...
namespace PlayBack
{
    public partial class PlayBackForm : Form
    {
        ...
        private void axXnsSdkDevice_OnDeviceStatusChanged(object sender, AxXNSSDKDEVICELib._DXnsSdkDeviceEvents_OnDeviceStatusChangedEvent e)
        {
            ...
            // -----------------------------------------------------------------------
            if (axXnsSdkDevice.GetControlCapability(hDevice, 1, (int)XUnitCap.XCTL_CAP_FSPEED1) != FALSE)
            {
                // [ XNS ACTIVEX HELP ]
		        // -----------------------------------------------------------------------
                ...
                {
                    if (axXnsSdkDevice.GetControlCapability(hDevice, i + 2, (int)XUnitCap.XCTL_CAP_PLAYBACK) != FALSE)
                    {
                        nControlID = i + 2;
                        break;
                    }
