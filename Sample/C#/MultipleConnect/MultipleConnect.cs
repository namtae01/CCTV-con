...
namespace MultipleConnect
{
    public partial class MultipleConnectForm : Form
    {
        ...
        private const string IP_ADDRESS = "192.168.85.28";
        ...
        struct DEVICEINFO
        {
            ...
            public int      nDeviceProtocol;    // Device Protocol
            public string   strIpAddress;		// IP Address
            public int      nPort;				// Port number
            public int      nHttpPort;          // Http port number
...
//             }
        ...
        private void BTN_ADD_Click(object sender, EventArgs e)
        {
            ...
            temp.nDeviceProtocol = nDeviceProtocol;
            temp.strIpAddress = strIpAddress;
            temp.nPort = nPort;
            temp.nHttpPort = nHttpPort;
            temp.strId = strID;
        ...
        private void BTN_CONNECT_Click(object sender, EventArgs e)
        {
            ...
            int nHttpPort = result.nHttpPort;
