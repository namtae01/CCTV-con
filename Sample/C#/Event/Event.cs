    ...
    public partial class EventForm : Form
    {
      ...
      //      m_DebugLog.WLOGD("ConnectNonBlock():: ", nError, axXnsSdkDevice.GetErrorString(nError));
        ...
        private void BTN_PLAY_Click(object sender, EventArgs e)
        {
            ...
            // Video information event 
            axXnsSdkDevice.SetVideoFrameInfoReceived(hDevice, nControlID, ((int)XMediaType.XMEDIA_LIVE), 1);
        ...
        private void axXnsSdkDevice_OnVideoFrameInfoReceived(object sender, AxXNSSDKDEVICELib._DXnsSdkDeviceEvents_OnVideoFrameInfoReceivedEvent e)
        {
            nIndex_DeviceLog++;
            nIndex_AllLog++;

            string strDeviceLog = "[Device Log][" + nIndex_DeviceLog.ToString() + "] / [Video frame info:" + e.nControlID.ToString() + ", fps=" + e.nFps.ToString() + ", bandwidth=" + e.nKbps.ToString() + "Kbps]";
            string strAllLog    = "[Device Log][" + nIndex_AllLog.ToString()    + "] / [Video frame info:" + e.nControlID.ToString() + ", fps=" + e.nFps.ToString() + ", bandwidth=" + e.nKbps.ToString() + "Kbps]";
