// CDXnsSdkWindow.h  : Declaration of ActiveX Control wrapper class(es) created by Microsoft Visual C++
...
class CDXnsSdkWindow : public CWnd
{
protected:
	DECLARE_DYNCREATE(CDXnsSdkWindow)
public:
