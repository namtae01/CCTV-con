...
//
	...
	CString GetControlLinkStatus(long hDevice, long nControlID)
	{
		CString result;
		static BYTE parms[] = VTS_I4 VTS_I4 ;
		InvokeHelper(0xde, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, hDevice, nControlID);
		return result;
	}
// Properties
//
