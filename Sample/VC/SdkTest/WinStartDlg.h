...
{
	DECLARE_DYNAMIC(CWinStartDlg)

public:
	CWinStartDlg(CWnd* pParent = NULL);   // standard constructor
	virtual ~CWinStartDlg();

// Dialog Data
	enum { IDD = IDD_DIALOG_WIN_START };
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedButtonWinInit();
	afx_msg void OnBnClickedButtonWinStart();
	afx_msg void OnBnClickedButtonWinStop();
	afx_msg void OnBnClickedButtonWinDeviceStatus();
};
