// CDXnsSdkWindow.h  : Microsoft Visual C++로 만든 ActiveX 컨트롤 래퍼 클래스의 선언입니다.
...
class CDXnsSdkWindow : public COleDispatchDriver
{
public:
	CDXnsSdkWindow() {}		// COleDispatchDriver 기본 생성자를 호출합니다.
	CDXnsSdkWindow(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CDXnsSdkWindow(const CDXnsSdkWindow& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
