// CDXnsSdkDevice.h  : Microsoft Visual C++로 만든 ActiveX 컨트롤 래퍼 클래스의 선언입니다.
...
public:
	...
	long SendAudioData(long hDevice, long hData, long nDataSize)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x3d, DISPATCH_METHOD, VT_I4, (void*)&result, parms, hDevice, hData, nDataSize);
		return result;
	}
